...
Options:
    ...
    -p --predict <vdat>       Not currently implemented. Predict for a specified dataset, then output statistics on this data.
...
def plot_importance(filename: str, booster: xgb.Booster, fm_fp: str,
    ...
    xgb.plot_importance(booster, grid=False, fmap=fm_fp, importance_type=msm_type,
                        max_num_features=feat_limit, title=title, xlabel=xlabel, show_values=False)
